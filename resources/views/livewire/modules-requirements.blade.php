<section>
    ...
    <br>
    <br>
    <h1 class="text-2xl font-bold">Requirements for beneficiary before start the assistance</h1>
    <hr class="mt-2 mb-6">
 
    @foreach ($module->requirements as $item)
           ...
           <div class="card-body bg-blue-100">
            ...
            @if ($requirement->id == $item->id)
              ...
              <form wire:submit.prevent="update">
                ...
                <input wire:model="requirement.name" class="form-input block w-full mt-1">
    ...
    <article class="card mt-5">
         <div class="card-body bg-blue-100">
            ...
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input block w-full mt-1" placeholder="Add title of the requirement that the beneficiary will see">
