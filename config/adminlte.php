...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'kinds and prices of the module'],
        [
            'text' => 'Kinds',
            'route'  => 'administrator.kinds.index',
            'active' =>['administrator/kinds*'],
            'icon' => 'fas fa-spa',
        ],
        [
            'text' => 'Prices',
            'route'  => 'administrator.prices.index',
            'active'  =>['administrator/prices*'],
